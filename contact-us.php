                        ...
                        <div class="col-lg-4 col-12">
                            ...
                            <div class="social-icon">
                                <ul class="d-flex justify-content-between p-0">
                                    <li><a href="#"><img src="images/facebook-icon.png" class="img-fluid" alt="Facebook"></a></li>
                                    <li><a href="#"><img src="images/instagram-icon.png" class="img-fluid" alt="Facebook"></a></li>
                                    <li><a href="#"><img src="images/linkedin-icon.png" class="img-fluid" alt="Facebook"></a></li>
                                    <li><a href="#"><img src="images/twitter-icon.png" class="img-fluid" alt="Facebook"></a></li>
                                    <li><a href="#"><img src="images/whatsapp-icon.png" class="img-fluid" alt="Facebook"></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-4 col-12">
                            ...
                            <p>
                                ...
                                IFcs Code- IDFB0021331<br>
                                A/C Holder Name- Atul Kumar Singh<br>
                                A/C Number- 5881577056<br>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container pb-lg-5">
                <div class="row">
                    <div class="col-12 text-center py-lg-0 py-3 form-footer p-lg-5">
                        ...
                        <a id="anotherresponse" href="https://parnav.org/new-01/contact-us.php" style="display:none; color:#F2B200;"><b>Submit Another Query !!!</b> </a>
