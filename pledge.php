    ...
    <div class="inner-container">
        <section class="Pledge-bg">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <h5 class="text-success">RAKTABHIYAN</h5><br>
                        <p>
                            <strong>Pledge :</strong><br>
                            I pledge to donate blood at least once a year, recognizing the invaluable impact it can have on saving lives.As a part of the Raktabhiyan initiative of Parnav Foundation, 
                            I will actively encourage others to join me in this selfless act. Together, we can contribute to a healthier and more compassionate world.
                        </p>
                    </div>
                    <div class="col-12 py-5">
                        <h2 id="voluntarysuccessmsg" style="display:none; color:green;">Thank You for Join our Initiative Raktabhiyan </h2>
                        <h2 id="voluntaryerrormsg" style="display:none; color:red;">Something Went Wrong. Kindly
                            Try
                            Again!!!
                        </h2>
                        <a id="anotherresponsevoluntary" href="https://parnav.org/pledge.php"
                            ...
                            <fieldset id="voluntary-form-id">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <label for="dtype">Do you agree to take pledge  of Voluntary Blood Donation once in a year? <span class="text-danger"></span></label>
                                    ...
                                    <div class="form-group col-md-12">
                                        <label for="dtype">Do you agree to make atleast person take this pledge? <span
                                                class="text-danger"></span></label>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <label for="dtype">Would you like to volunteer with us ? <span
                                                class="text-danger"></span></label>
                                        <select class="form-control" name="pledge_person"
                                            title="Do you agree to make one person take this pledge?"
                                            id="pledge_person">
