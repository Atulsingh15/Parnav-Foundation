            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 py-5">
                        ...
                        <a id="anotherresponsevoluntaryreg" href="https://parnav.org/new-01/volunteer-registration.php"
                        ...
                        <form id="volunteer-form">
                            <fieldset id="volunteer-form-id">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" title="Last Name"
                                            class="form-control inputTextBox mandatoryvalue" name="vlname" id="vlname"
                                ...
                                <div class="form-group">
                                    <button type="button" id="volunterreg_submit" onclick="submitVolunterreg()"
