                                ...
                                <form>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" placeholder="" class="form-control" id="ration-kit">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                            ...
                            <div class="col-12">
                                <form>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="food-items">Food Item</label>
                                            <input type="text" placeholder="" class="form-control" id="food-items">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                            ...
                            <div class="col-12">
                                <form>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="food-items">Clothes</label>
                                            <input type="text" placeholder="" class="form-control" id="food-items">
                                        </div>
                                    </div>
                                    <div class="form-row">
